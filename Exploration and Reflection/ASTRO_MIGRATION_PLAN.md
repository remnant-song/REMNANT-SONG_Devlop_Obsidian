...
**修订说明**：本次修订删除了“抽离内容仓”相关任务，改为“建立内容制品与同步机制”，并补充了对 Astro + Vue 结合使用的指导，以匹配当前项目实际情况和最终选型决策。