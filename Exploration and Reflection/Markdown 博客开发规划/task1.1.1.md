...
第一篇示例文章 `src/content/posts/2026-08-09-hello-blog.md` 内容（**覆盖所有标准语法，后续每一步的回归样例**）：
```markdown
# 你好，博客

这是第一篇示例文章，用于验证 **Markdown** 渲染链路。
...
|  C   |  D   |
```
（注意：上面实际代码块的反引号使用三反引号即可，文档中为了嵌套显示用了反斜杠转义，实际写 md 时不要加反斜杠。）
